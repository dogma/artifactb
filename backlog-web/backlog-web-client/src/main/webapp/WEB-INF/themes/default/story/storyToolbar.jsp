...
<c:if test="${not empty story && not empty story.storyId}">
    <div id="story-toolbar">
        ...
        <a href="<c:url value="/projects/project/${project.projectId}/story/${story.storyId}/notes/new" />" class="add-note-button">Add Note</a>

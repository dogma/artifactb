...
CREATE SEQUENCE "BL_STORY_SEQ" AS INTEGER START WITH 5 INCREMENT BY 1;
...
CREATE SEQUENCE "BL_ITERATION_SEQ" AS INTEGER START WITH 4 INCREMENT BY 1;
...
CREATE SEQUENCE "BL_ITER_TASK_SEQ" AS BIGINT START WITH 15 INCREMENT BY 1 ;
